...
import { DashboardRoutingModule } from './modules/body/dashboard/dashboard-routing.module';
...
const routes: Routes = [
  ...
  { path: 'dashboard', loadChildren: './modules/body/dashboard/dashboard.module#DashboardModule' },
